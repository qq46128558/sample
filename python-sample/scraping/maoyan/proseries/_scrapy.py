...
# 通过Fiddler分析得到数据接口地址, 以优酷网8月11号电视剧播放量为例： http://maoyan.com/proseries/api/seriesTopRank.json?platformType=1&seriesType=0&dateRange=0&date=2018-08-11
